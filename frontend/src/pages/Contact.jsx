      ...
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
          {[
            ...
            else if (isEmail) cardHref = `https://mail.google.com/mail/?view=cm&fs=1&to=${item.details[0].trim()}`;

            return (
              <motion.a
                key={index}
                href={cardHref}
                target={isLocation || isWhatsApp || isEmail ? "_blank" : undefined}
                rel={isLocation || isWhatsApp || isEmail ? "noopener noreferrer" : undefined}
